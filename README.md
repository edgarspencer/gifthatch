...
There's a short Loom walking through merchant setup → storefront experience → checkout receipt at the link in the project root (added separately, not in repo).
